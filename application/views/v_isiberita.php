...
<body>
  ...
  ============================-->
    ...
    <main id="main">
      ...
      About Us Section
    ============================-->
    <section id="detail-berita" class="section-bg">
            <div class="container">
                <header class="section-header">
                    <h3><?php echo $berita->tulisan_judul; ?></h3>
                </header>

                <div class="row">
                    <div class="col-md-12">
                        <div class="detail-content">
                            <img src="<?php echo base_url() . 'assets/images/' . $berita->tulisan_gambar; ?>" class="img-fluid" alt="">
                            <p><strong>Kategori Berita:</strong> <?php echo $berita->tulisan_kategori_nama; ?></p>
                            <p><strong>Tanggal:</strong> <?php echo date('d F Y', strtotime($berita->tulisan_tanggal)); ?></p>
                            <p><?php echo ($berita->tulisan_isi); ?></p>
                        </div>
                    </div>
                </div>

                <div class="back-button">
                    <a href="<?php echo base_url() . 'Home'; ?>" class="btn btn-primary">Kembali ke Berita</a>
                </div>
            </div>
        </section>
